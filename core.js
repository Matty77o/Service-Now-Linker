 ...
 */
  ...
  function findAndReplaceKB(){
    findAndReplace('\\b(KB\\d{7})\\b',
                   '<a href=\"https://hs2prod.service-now.com/kb_view.do?sysparm_article=$&\" target=\"_blank\">$&</a>'
    );
  }
  function findAndReplaceINC(){
    findAndReplace('\\b(INC\\d{7})\\b',
                   '<a href=\"https://hs2prod.service-now.com/textsearch.do?sysparm_no_redirect=true&sysparm_search=$&\" target=\"_blank\">$&</a>'
    );
